...
$(document).ready(function () {
    $('#Tableknowledge').DataTable({
        ...
        buttons: [
            ...
            {
                text: '<i class="ti ti-plus me-0 me-sm-1 ti-xs"></i><span class="d-none d-sm-inline-block">Add Knowledge</span>',
    ...
    $('.card').on('click', '.dt-action-buttons .add-new', function() {
        ...
        $('#offcanvasAddknowledgeLabel').text('Add Knowledge');
    ...
    $(document).on('click', '.delete-record', function () {
        ...
        Swal.fire({
            title: 'Are you sure?',
            text: "Knowledge data will be deleted!",
            icon: 'warning',
