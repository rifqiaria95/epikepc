...
$(document).ready(function () {
    ...
    $('.card').on('click', '.dt-action-buttons .add-new', function() {
        ...
        $('#offcanvasAddkategoriLabel').text('Add Kategori');
    ...
    $("#formkategori").submit(function (e) {
        ...
        let id       = $("#id").val();
        let url      = "/internal/news/kategori/store";
        let method   = "POST";

        if (id) {
            url = "/internal/news/kategori/update/" + id;
    ...
    $(document).on('click', '.delete-record', function () {
        ...
        Swal.fire({
            title: 'Are you sure?',
            text: "Category data will be deleted!",
            icon: 'warning',
            ...
            if (result.isConfirmed) {
                $.ajax({
                    url: '/internal/news/kategori/delete/' + id,
                    type: 'DELETE',
                    data: {
                        _method: 'DELETE',
