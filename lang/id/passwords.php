...
return [
    ...
    | yang diberikan oleh pialang kata sandi untuk upaya pembaruan kata sandi
    | seperti kegagalan karena token kata sandi / atur ulang yang tidak valid.
    |
    */

    'reset' => 'Kata sandi Anda telah diatur ulang.',
    'sent' => 'Kami telah mengirimkan tautan atur ulang kata sandi Anda melalui email.',
