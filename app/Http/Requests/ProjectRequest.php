...
class ProjectRequest extends FormRequest
{
    ...
    public function messages(): array
    {
        return [
            ...
            'image_secondary.max'    => 'Gambar yang diupload melebihi 5 MB',
            'image_secondary.uploaded' => 'Gambar yang diupload melebihi 5 MB',
            'image_tertiary.image'   => 'File harus berupa gambar.',
            'image_tertiary.mimes'   => 'Format gambar yang diizinkan: jpg, jpeg, png, webp.',
            'image_tertiary.max'     => 'Gambar yang diupload melebihi 5 MB',
            'image_tertiary.uploaded' => 'Gambar yang diupload melebihi 5 MB',
