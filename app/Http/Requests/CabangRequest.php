...
class CabangRequest extends FormRequest
{
    ...
    public function messages(): array
    {
        return [
            ...
            'id_perusahaan.required' => 'Company wajib dipilih.',
            'id_perusahaan.exists'   => 'Company yang dipilih tidak valid.',
            'alamat_cabang.string'   => 'Address harus berupa teks.',
            'no_telp_cabang.string'  => 'Phone harus berupa teks.',
            'no_telp_cabang.max'     => 'Phone maksimal 20 karakter.',
