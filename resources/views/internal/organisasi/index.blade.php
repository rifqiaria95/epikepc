...
@section('content')
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
              ...
              <div class="card-body">
                <div class="d-flex align-items-start justify-content-between">
                  <div class="content-left">
                    ...
                    <small class="mb-0">Total Organisasi</small>
                  </div>
                  <div class="avatar">
          ...
          <div class="col-sm-6 col-xl-3">
            <div class="card">
              <div class="card-body">
                <div class="d-flex align-items-start justify-content-between">
                  <div class="content-left">
                    <span class="text-heading">Paid Organisasi</span>
                    <div class="d-flex align-items-center my-1">
          ...
          <div class="col-sm-6 col-xl-3">
            <div class="card">
              <div class="card-body">
                <div class="d-flex align-items-start justify-content-between">
                  <div class="content-left">
                    <span class="text-heading">Active Organisasi</span>
                    <div class="d-flex align-items-center my-1">
          ...
          <div class="col-sm-6 col-xl-3">
            <div class="card">
              <div class="card-body">
                <div class="d-flex align-items-start justify-content-between">
                  <div class="content-left">
                    <span class="text-heading">Pending Organisasi</span>
                    <div class="d-flex align-items-center my-1">
        ...
        <!-- Organisasi List Table -->
        <div class="card">
            <div class="card-header border-bottom">
                <h5 class="card-title mb-0">Filters</h5>
                <div class="d-flex justify-content-between align-items-center row pt-4 gap-4 gap-md-0">
                <div class="col-md-4 organisasi_role"></div>
                <div class="col-md-4 organisasi_plan"></div>
                <div class="col-md-4 organisasi_status"></div>
                </div>
            </div>
            <div class="card-datatable table-responsive">
                <table id="TableOrganisasi" class="datatables-organisasi table">
                                            ...
                                            <div class="tab-content">
                                                <div class="tab-pane fade show active" id="navs-top-home" role="tabpanel">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-xl-6 mb-6">
                                                            <label class="form-label" for="subtitle">Jabatan</label>
                                                            <input
                                                                type="text"
                                                                class="form-control"
                                                                id="jabatan"
...
<script src="{{ asset('assets/ajax/organisasi.js') }}"></script>
@endsection
