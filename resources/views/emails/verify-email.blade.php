                    ...
                    <tr>
                        <td style="padding: 40px 30px;">
                            ...
                            <div style="font-size: 16px; color: #6b7280; line-height: 1.7; margin-bottom: 30px;">
                                <p style="margin: 0 0 15px 0;">Thank you for registering with <strong>{{ config('app.name') }}</strong>! We are glad to have you on board.</p>

                                <p style="margin: 0 0 15px 0;">To complete registration and secure your account, please verify your email address by clicking the button below:</p>
                            </div>
                            ...
                            <div style="font-size: 14px; color: #9ca3af; line-height: 1.6; margin-top: 30px; padding-top: 20px; border-top: 1px solid #e5e7eb;">
                                <p style="margin: 0 0 10px 0;"><strong>Having trouble with the button above?</strong></p>
                                <p style="margin: 0 0 10px 0;">Copy and paste the following URL into your browser:</p>
                                <p style="margin: 0 0 20px 0; word-break: break-all; color: #3b82f6;">{{ $verificationUrl }}</p>

                                <p style="margin: 0; font-size: 12px;">
                                    <strong>Note:</strong> This verification link will expire in 60 minutes for your account security.
                                </p>
                            </div>
                        </td>
                    </tr>
